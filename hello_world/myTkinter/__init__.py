...
class Tk(Misc, Wm):
    ...
    def __init__(self, screenName=None, baseName=None, className='Tk',
        ...
        interactive = False
        # TODO: Print
        # print(screenName, baseName, className, interactive, wantobjects, useTk, sync, use)
        self.tk = TkWrapper(screenName, baseName, className, interactive, wantobjects, useTk, sync, use)
        if useTk:
            self._loadtk()
